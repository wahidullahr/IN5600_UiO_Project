...
class HomeActivity : AppCompatActivity() {
    ...
    private lateinit var userInfo: Button
    ...
    private fun getUserInfo() {
        ...
        println(username)
        println(sharedPreferences.getString("first name", ""))
        println(sharedPreferences.getString("last name", ""))
        println(sharedPreferences.getString("email", ""))
        println(sharedPreferences.getString("birth year", ""))
